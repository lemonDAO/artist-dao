      ...
      <div className=" flex max-w-7xl mx-auto px-4 sm:px-6 bg-main-gray">
        <div className="absolute py-16 sm:py-24 lg:py-32 max-w-7xl">
          ...
          <div className="mt-10 max-w-sm sm:max-w-none sm:flex sm:justify-start">
              ...
              <a href="#" className="flex items-start justify-start px-4 mr-6 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-indigo-700 bg-white hover:bg-indigo-50 sm:px-8">
                Get started
              </a>
              <a href="#" className="flex items-start justify-start px-4 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-indigo-500 bg-opacity-60 hover:bg-opacity-70 sm:px-8">
                Learn more
              </a>
